...
import { Star, Users, BookOpen, Award, ChevronRight, ChevronLeft } from 'lucide-react';
...
  const handlePrev = () => {
    setCurrentVideoIndex((prevIndex) => (prevIndex - 1 + youtubeVideoIds.length) % youtubeVideoIds.length);
  };
...
              </div>
              <h3 className="text-2xl font-serif font-bold text-moss-green mb-4">Missão</h3>
...
              </div>
              <h3 className="text-2xl font-serif font-bold text-moss-green mb-4">Valores</h3>
              <p className="text-dark-brown leading-relaxed">
...
              </div>
              <h3 className="text-2xl font-serif font-bold text-moss-green mb-4">Comunidade</h3>
              <p className="text-dark-brown leading-relaxed">
                Um espaço de apoio e troca, onde profissionais e entusiastas das terapias naturais se conectam, aprendem e crescem juntos.
              </p>
            </div>
          </div>
        </div>
...
                  src={`https://www.youtube.com/embed/${youtubeVideoIds[currentVideoIndex]}?rel=0&controls=1&autoplay=0`}
                  title={`Depoimento de Aluno ${currentVideoIndex + 1}`}
                  frameBorder="0"
...
                type="button"
                onClick={handlePrev}
                className="absolute left-2 top-1/2 -translate-y-1/2 z-10 p-2 bg-moss-green/50 hover:bg-moss-green text-cream rounded-full transition-colors"
              >
...
                type="button"
                onClick={handleNext}
                className="absolute right-2 top-1/2 -translate-y-1/2 z-10 p-2 bg-moss-green/50 hover:bg-moss-green text-cream rounded-full transition-colors"
              >
