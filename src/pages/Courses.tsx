...
    {
      id: 1,
      title: 'Apiterapia', // Título alterado para "Apiterapia"
...
              </div>
              {/* O item Suporte Vitalício foi removido daqui */}
            </div>
          </div>
        </div>
      </section>
...
              className="bg-mustard hover:bg-mustard/90 text-dark-brown px-6 py-3 rounded-full font-medium transition-all duration-300 hover:shadow-lg transform hover:scale-105 text-lg sm:text-base md:text-lg"
            >
