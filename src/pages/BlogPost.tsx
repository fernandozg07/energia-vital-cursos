...
const blogPosts = [
  ...
  },
  {
    ...
    content: `
      ...
      <p>É importante ressaltar que, embora as pesquisas sejam promissoras, a geleia real deve ser consumida como um suplemento e não como um substituto para tratamentos médicos convencionais. Pessoas com alergia a produtos de abelha ou asma devem evitar o uso, pois pode haver risco de reações alérgicas graves.</p>
    `,
  },
];

// Componente para a página de lista de posts do blog
// Exibe um cartão para cada post, com link para a página completa.
const BlogList = () => {
  return (
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
          {blogPosts.map((post) => (
            <Link
              key={post.slug}
              to={`/blog/${post.slug}`} // O link usa o slug do post para a navegação
...
// Usa o hook useParams para buscar o post correto e renderizar o conteúdo completo.
const BlogPost = () => {
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <article className="prose prose-lg max-w-none">
            <div
              ...
              // Usa dangerouslySetInnerHTML para renderizar o HTML armazenado em post.content
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {relatedPosts.length > 0 ? (
            <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-8">
              {/* Mapeia os posts relacionados para criar os cartões */}
