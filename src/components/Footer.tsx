...
                <span className="text-dark-brown font-bold text-lg">EV</span>
              </div>
              <div>
...
              {/* AQUI: Link do WhatsApp corrigido */}
              <a
...
              </a>
              
              {/* AQUI: E-mail e Instagram adicionados */}
              <a
...
              <li>
                <Link
                  to="/curso/acupuntura-tradicional"
                  className="text-cream/80 hover:text-mustard transition-colors duration-200"
                >
